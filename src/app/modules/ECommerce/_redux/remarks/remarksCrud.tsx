...
export function createRemark(remark: any) {
  return axios.post(REMARKS_URL, { remark });
}

// READ
// Server should return filtered remarks by productId
export function getAllProductRemarksByProductId(productId: any) {
  return axios.get(`${REMARKS_URL}?productId=${productId}`);
}

export function getRemarkById(remarkId: any) {
