          ...
          <div className="form-group form-group-inline">
            <div className="form-label form-label-no-wrap">
              <label className="-font-bold font-danger-">
                <span>
                Сонгосон бичлэгийн тоо: <b>{productsUIProps.ids.length}</b>
                </span>
              </label>
            </div>
            <div>
              ...
              >
                <i className="fa fa-trash"></i> Бүгдийг нь устгах
              </button>
              &nbsp;
              <button
                type="button"
              ...
              >
                <i className="fa fa-stream"></i> Сонгосон авах
              </button>
              &nbsp;
              <button
                type="button"
              ...
              >
                <i className="fa fa-sync-alt"></i> Статусыг шинэчлэх
              </button>
            </div>
          </div>
        </div>
